...
- 工作階段區塊會以醒目狀態顯示目前工作階段、收音、Speech 授權與字幕事件計數；字幕事件計數目前會統計 Speech Translation 產生的最終字幕結果。
...
- 已授權 Speech 設定並開啟收音後，點擊「開始字幕」才會以主控板選定的音訊來源啟動 Speech Translation；即時區顯示目前語音語言的中間與最終辨識文字。
