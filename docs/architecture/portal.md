...
校正原始語言字幕時，Portal 要求 Azure OpenAI 保留候選文字或最近前文支持的英文單字、技術詞與拉丁字母品牌/產品名稱，不得把拉丁字母英文詞替換成非拉丁文字的近音詞。
